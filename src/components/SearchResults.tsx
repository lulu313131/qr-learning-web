...
export default function SearchResults({
  ...
  return (
    <div className="space-y-8">
      <h2 className="text-[28px] font-bold text-[var(--text-primary)]">
        「<span className="text-[var(--accent)]">{query}</span>」的搜尋結果
      </h2>

      {hasCourses && (
        <section>
          <h3 className="mb-3 border-b border-[var(--border)] pb-2 text-[13px] font-semibold tracking-[0.12em] text-[var(--text-muted)] uppercase">
            相關課程
          </h3>
